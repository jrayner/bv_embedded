...
extern int lgsm_voice_volume_set(struct lgsm_handle *lh, int volume);

/* Cancel specified voice call request */
extern int lgsm_voice_cancel(struct lgsm_handle *lh, int subtype);
